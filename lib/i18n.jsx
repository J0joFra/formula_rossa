...
const DICT = {
  it: {
    ...
    gu_open: 'Apri l’app', gu_getOn: 'Scarica su', gu_playAria: 'Scarica GridUp su Google Play',
  ...
  en: {
    ...
    gu_open: 'Open the app', gu_getOn: 'Get it on', gu_playAria: 'Get GridUp on Google Play',
  ...
  fr: {
    ...
    gu_open: 'Ouvrir l’application', gu_getOn: 'Disponible sur', gu_playAria: 'Télécharger GridUp sur Google Play',
  ...
  es: {
    ...
    gu_open: 'Abrir la app', gu_getOn: 'Disponible en', gu_playAria: 'Descargar GridUp en Google Play',
  ...
  de: {
    ...
    gu_open: 'App öffnen', gu_getOn: 'Jetzt bei', gu_playAria: 'GridUp bei Google Play herunterladen',
