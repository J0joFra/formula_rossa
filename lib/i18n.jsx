...
const DICT = {
  it: {
    ...
    gu_terms: 'Gratis · Android · Nessuna registrazione richiesta',
  ...
  en: {
    ...
    gu_terms: 'Free · Android · No sign-up required',
  ...
  fr: {
    ...
    gu_terms: 'Gratuit · Android · Sans inscription',
  ...
  es: {
    ...
    gu_terms: 'Gratis · Android · Sin registro',
  ...
  de: {
    ...
    gu_terms: 'Kostenlos · Android · Ohne Registrierung',
