...
// ─── CALENDARIO 2026 (stesso di PredictorSection) ────────────────────────────
export const FANTA_CALENDAR = [
  { round: 1,  raceId: '2026-R01', name: 'Australian GP',     circuitId: 'albert-park',      date: '2026-03-15', lockDate: '2026-03-14' },
  { round: 2,  raceId: '2026-R02', name: 'Chinese GP',        circuitId: 'shanghai',          date: '2026-03-22', lockDate: '2026-03-21' },
  { round: 3,  raceId: '2026-R03', name: 'Japanese GP',       circuitId: 'suzuka',            date: '2026-04-05', lockDate: '2026-04-04' },
  { round: 4,  raceId: '2026-R04', name: 'Bahrain GP',        circuitId: 'bahrain',           date: '2026-04-19', lockDate: '2026-04-18' },
  { round: 5,  raceId: '2026-R05', name: 'Saudi Arabia GP',   circuitId: 'jeddah',            date: '2026-04-26', lockDate: '2026-04-25' },
  { round: 6,  raceId: '2026-R06', name: 'Miami GP',          circuitId: 'miami',             date: '2026-05-10', lockDate: '2026-05-09' },
  { round: 7,  raceId: '2026-R07', name: 'Emilia Romagna GP', circuitId: 'imola',             date: '2026-05-24', lockDate: '2026-05-23' },
  { round: 8,  raceId: '2026-R08', name: 'Monaco GP',         circuitId: 'monte-carlo',       date: '2026-05-31', lockDate: '2026-05-30' },
  { round: 9,  raceId: '2026-R09', name: 'Spanish GP',        circuitId: 'barcelona',         date: '2026-06-14', lockDate: '2026-06-13' },
  { round: 10, raceId: '2026-R10', name: 'Canadian GP',       circuitId: 'villeneuve',        date: '2026-06-21', lockDate: '2026-06-20' },
  { round: 11, raceId: '2026-R11', name: 'Austrian GP',       circuitId: 'red-bull-ring',     date: '2026-07-05', lockDate: '2026-07-04' },
  { round: 12, raceId: '2026-R12', name: 'British GP',        circuitId: 'silverstone',       date: '2026-07-19', lockDate: '2026-07-18' },
  { round: 13, raceId: '2026-R13', name: 'Hungarian GP',      circuitId: 'hungaroring',       date: '2026-08-02', lockDate: '2026-08-01' },
  { round: 14, raceId: '2026-R14', name: 'Belgian GP',        circuitId: 'spa-francorchamps', date: '2026-08-30', lockDate: '2026-08-29' },
  { round: 15, raceId: '2026-R15', name: 'Dutch GP',          circuitId: 'zandvoort',         date: '2026-09-06', lockDate: '2026-09-05' },
  { round: 16, raceId: '2026-R16', name: 'Italian GP',        circuitId: 'monza',             date: '2026-09-13', lockDate: '2026-09-12' },
  { round: 17, raceId: '2026-R17', name: 'Azerbaijan GP',     circuitId: 'baku',              date: '2026-09-27', lockDate: '2026-09-26' },
  { round: 18, raceId: '2026-R18', name: 'Singapore GP',      circuitId: 'marina-bay',        date: '2026-10-04', lockDate: '2026-10-03' },
  { round: 19, raceId: '2026-R19', name: 'US GP',             circuitId: 'austin',            date: '2026-10-18', lockDate: '2026-10-17' },
  { round: 20, raceId: '2026-R20', name: 'Mexico City GP',    circuitId: 'rodriguez',         date: '2026-10-25', lockDate: '2026-10-24' },
...
// ─── SISTEMA PUNTI ────────────────────────────────────────────────────────────
export const POINTS = {
  exactPosition:    10,  // posizione esatta
  podiumWrong:       4,  // nel podio ma posizione sbagliata
  top10Wrong:        2,  // in top10 ma posizione sbagliata
  lastFiveExact:     5,  // tra gli ultimi 5, posizione esatta
  lastFiveWrong:     3,  // tra gli ultimi 5, pilota corretto ma pos sbagliata
  fastestLapExact:   5,  // giro veloce esatto
  safetyCarCorrect:  3,  // safety car corretta
};

// ─── GARA CORRENTE / PROSSIMA ─────────────────────────────────────────────────
export function getCurrentRace() {
  const now = new Date();
  // Trova la prima gara non ancora corsa
...
export function calculateScore(prediction, result) {
  ...
  predGrid.forEach(({ pos, driverId }) => {
    ...
    if (realEntry.pos === pos) {
      ...
      breakdown.exactPositions += POINTS.exactPosition;
    } else if (pos <= 3 && realEntry.pos <= 3) {
      // Nel podio ma pos sbagliata
      pts += POINTS.podiumWrong;
      breakdown.podiumPartial += POINTS.podiumWrong;
    } else if (pos <= 10 && realEntry.pos <= 10) {
      // In top10 ma pos sbagliata
  ...
  // ── Ultimi 5 ──────────────────────────────────────────────────────────────
  (prediction.lastFive || []).forEach(({ pos, driverId }) => {
    const realEntry = realGrid.find(r => r.driverId === driverId);
    if (!realEntry) return;
    const isInLastFive = realEntry.pos >= 16;
    if (isInLastFive) {
      if (realEntry.pos === pos) {
        pts += POINTS.lastFiveExact;
        breakdown.lastFiveExact += POINTS.lastFiveExact;
      } else {
        pts += POINTS.lastFiveWrong;
        breakdown.lastFivePartial += POINTS.lastFiveWrong;
      }
    }
  });
...
export async function saveScore(userId, raceId, score) {
  ...
  // Aggiorna leaderboard stagionale
