...
export const REGOLE = {
  ...
  malus: {
    // Mettere qualcuno sul podio è una scommessa: se finisce fuori dai punti,
    // si paga. Non si penalizza invece il semplice errore di posizione — chi
    // rischia deve poterlo fare senza essere punito due volte.
