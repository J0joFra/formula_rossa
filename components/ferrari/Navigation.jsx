...
import { Home as HomeIcon, BarChart3, Gamepad2, LayoutDashboard, LogOut, Gauge, Trophy, User, Zap, Info } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <NavLink href="/about" icon={Info} label="Chi Siamo" />
        ...
        {isMenuOpen && (
          ...
          >
            <div className="px-4 py-6 space-y-3">
              ...
              <MobileLink href="/about" label="Chi Siamo" onClick={() => setIsMenuOpen(false)} />
